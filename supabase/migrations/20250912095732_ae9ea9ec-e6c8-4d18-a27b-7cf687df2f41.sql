-- Add sample events with valid event types to demonstrate the system functionality
INSERT INTO public.events (title, description, location, theme, start_date, end_date, event_type, category, industry_sector, status, tags) VALUES 
  ...
  (
    'Marketing Excellence Seminar',
    'An educational seminar on the latest trends in digital marketing, brand strategy, and customer engagement.',
